...
import {
    GetOriginalUrlAndIncrementCountingService
} from '../../application/get-original-url-and-increment-counting.service';


@Injectable()
export class GetOriginalUrlAndIncrementCountingUseCase implements GetOriginalUrlAndIncrementCountingService {
    constructor(
